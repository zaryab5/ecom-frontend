...
const Shipping = () => {
  return (
    <div className=" mx-auto    lg:m-10 flex md:flex-row flex-col flex-wrap ">
      <main className=" flex-1 lg:p-5 w-[80vw] mx-auto ">
        ...
        <div className=" py-10  w-fit">
          <AddressOption/>
          <h2 className=" font-bold pb-5">Add New Address</h2>
         <AddAddress/>
        </div>
      </main>
...
const AddressOption=()=>(
  <div>
            <h2 className=" font-bold pb-5">Select a delivery address</h2>
            <p className=" w-[80vw] lg:w-auto">
            ...
            <div className=" py-5 flex flex-col lg:flex-row gap-5">
              <div className=" p-5 w-80 border-2 rounded-md  ">
                <div className="pb-5 flex justify-between items-center">
                  <h2 className=" font-bold ">Robert Fox</h2>
                  <input  type="radio" name="option" id="" />
                </div>
                <p >
                  4517 Washington Lorem ipsum dolor sit amet consectetur
                  adipisicing elit.
                </p>
                <div className=" pt-4 flex justify-between ">
                  <button className=" shadow-sm px-10 py-2  bg-teal-200 border-[1px] border-black/10 hover:bg-teal-300 rounded-md flex gap-2 items-center">
                    <FaEdit />
                    Edit
                  </button>
                  <button className=" text-red-700 border-[1px] border-black/10 shadow-sm px-10 py-2 bg-teal-200 hover:bg-teal-300 rounded-md flex gap-2 items-center">
                 Delete</button>
                </div>
              
               
              </div>
              <div className=" p-5 w-80 border-[2px] rounded-md ">
                <div className="pb-5 flex justify-between items-center">
                  <h2 className=" font-bold ">Robert Fox</h2>
                  <input  type="radio" name="option" id="" />
                </div>
            ...
            <Link
            to={"/payment"}
            className="text-white block mb-10 w-32 bg-secondary-3 hover:bg-red-400 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm sm:w-auto px-5 py-2.5 text-center"
            >
            Deliver Here
          </Link>
            </div>
...
const AddAddress=()=>(
  ...
  <button
    type="submit"
    className="text-white bg-secondary-3 hover:bg-red-400 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center"
  >
    Add Address
  </button>
</form>
